      ...
      onCreate: (db, version) async {
        ...
        for (int i = 0; i < 4; i++) {
          String sql_insert_video =
              "INSERT INTO video(name, description, type, ageRestriction, durationMinutes, thumbnailImageId, releaseDate, creatorid) VALUES('${videos[i]["name"]}', 'Descrição $i', 0, '18 anos', 120, '${videos[i]["url"]}', '01/01/2020', $i);";
          //type = 0 - filme
          //type = 1 - video
        ...
        String add_serie =
            "INSERT INTO video(name, description, type, ageRestriction, durationMinutes, thumbnailImageId, releaseDate, creatorid) VALUES('Flash', 'Série do flash', 1, '18 anos', 120, 'http://fr.web.img6.acsta.net/pictures/20/08/12/11/02/3069967.jpg', '01/01/2020', 0);";
